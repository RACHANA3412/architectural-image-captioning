...
# CONFIGURATION
# -------------------------------
dataset_dir = r'C:\Users\Rachana\OneDrive\Desktop\Architectural image\datasetss - Copy'
csv_file = os.path.join("captions_architecture.csv")
inception_weights = r'C:\Users\Rachana\OneDrive\Desktop\Architectural image\inception_v3_weights_tf_dim_ordering_tf_kernels_notop.h5'
